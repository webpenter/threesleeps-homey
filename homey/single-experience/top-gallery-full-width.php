...
if(!empty($experience_images)) {
    ...
    <div class="top-gallery-section top-gallery-full-width-section">
        <div class="experience-slider experience-slider-full-width">
    ...
    <?php fancybox_gallery_html($experience_images, 'fanboxTopGalleryFullWidth');//hidden images for gallery fancybox 3 ?>
<?php } ?>