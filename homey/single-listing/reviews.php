		...
		<li id="review-<?php the_ID();?>" class="review-block">
			<div class="media">
				...
				<div class="media-body media-middle">
                    ...
                    <div class="review-replies review-replies-<?php echo $review_parent_id; ?>">
                        <?php
                        $review_replies = get_review_replies($review_parent_id);

                        if($review_replies->have_posts()) {
                            while($review_replies->have_posts()): $review_replies->the_post();
                            $review_reply_author = homey_get_author('70', '70', 'img-circle');
                        ?>
                        <div class="media media-reply-item">
                            <div class="media-left">
                                <a class="media-object">
                                    <?php echo ''.$review_reply_author['photo']; ?>
                                </a>
                            </div>
                            <div class="media-body media-middle">
                                <div class="msg-user-info">
                                    <div class="msg-user-left">
                                        <div>
                                            <strong><?php echo esc_attr($review_reply_author['name']); ?></strong>
                                        </div>
                    ...
                    <form class="add-review-reply reply-form mt-2 ml-4" data-review-parent-id="<?php echo $review_parent_id; ?>">
                        <input type="hidden" name="review-reply-security" id="review-reply-security" value="<?php echo wp_create_nonce('review-reply-security-nonce'); ?>"/>

                        <div class="form-group">
                            <textarea id="review_reply_content_<?php echo $review_parent_id; ?>" name="review_reply_content" class="form-control" rows="3" placeholder="<?php echo esc_html__('Write your reply to main review.', 'homey'); ?>" required></textarea>
                        </div>
                        <button type="button" data-parent-review-id="<?php echo $review_parent_id; ?>" class="btn btn-sm btn-primary btn-review-reply"><?php echo esc_html__('Submit Reply', 'homey'); ?></button>
                    </form><!-- reply-form -->
