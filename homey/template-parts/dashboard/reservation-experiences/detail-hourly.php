...
<div class="user-dashboard-right dashboard-with-sidebar">
                    ...
                    <div class="dashboard-area">
                        ...
                        <div class="block">
                            ...
                            if($reservation_status == 'declined') {
                                ...
                                if(homey_is_renter()) {
                                    get_template_part('template-parts/dashboard/reservation-experiences/cancel-hourly-form');
                                } else {
                                    get_template_part('template-parts/dashboard/reservation-experiences/decline-hourly-form');
                                }
                            }
    ...
    <aside class="dashboard-sidebar">
        <?php get_template_part('template-parts/dashboard/reservation-experiences/payment-sidebar-hourly'); ?>
