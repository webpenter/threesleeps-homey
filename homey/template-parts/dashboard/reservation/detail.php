...
$no_logged_in_user = get_post_meta($reservationID, 'no_logged_in_user', true);

if( $no_logged_in_user == false && !homey_give_access($reservationID) ) {
                                    ...
                                    <div class="block-body">
                                        ...
                                        <div class="block-right">
                                            ...
                                            <ul class="detail-list">
                                                ...
                                                <?php $renter_information_on_detail = (int) $booking_detail_hide_fields['renter_information_on_detail']; if($renter_information_on_detail == 0){ ?>
