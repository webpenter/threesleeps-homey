                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="virtual_tour"><?php echo esc_html__('Enter virtual tour embed code.', 'homey'); ?></label>
                            <textarea id="virtual_tour" form-control" name="virtual_tour" rows="7"
                                      placeholder="<?php echo esc_html__(homey_option('cl_virtual_plac', 'Enter virtual tour iframe/embeded code'), 'homey'); ?>"><?php echo $virtual_tour; ?></textarea>
                        </div>
                    </div>
                </div>
