            ...
            <?php if($homey_booking_type == 'per_hour') { ?>
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="number" name="min_book_days" <?php homey_required('min_book_days'); ?> min-value="2" value="<?php echo esc_attr($min_book_days); ?>" class="form-control" id="min_book_days" placeholder="<?php echo esc_attr(homey_option('ad_min_days_booking_plac')); ?>">
                    </div>
                </div>
                <?php } ?>
