...
$iCal_export_link = homey_generate_exp_ical_export_link($experience_id);

homey_generate_exp_ical_dot_ics_url($experience_id);
$ics_file_url = get_post_meta($experience_id, "icalendar_file_url_with_ics", true);
?>
