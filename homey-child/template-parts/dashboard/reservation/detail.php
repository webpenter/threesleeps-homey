...
if(!empty($reservationID)) {
    ...
    $matched_rooms = get_post_meta($reservationID, 'reservation_selected_rooms', true);
                                ...
                                <div class="block-body">
                                    ...
                                    <div class="block-right">
                                        ...
                                        <ul class="detail-list">
                                            ...
                                            <?php if(!empty($matched_rooms)) : ?>
                                                <li>
                                                    <strong><?php esc_html_e('Rooms', 'homey'); ?>:</strong>
                                                    <ul>
                                                        <?php foreach($matched_rooms as $room): ?>
                                                            <li>
                                                                <strong><?php echo esc_html($room['name']); ?></strong> 
                                                                (<?php echo esc_html($room['tota_beds']); ?> <?php esc_html_e('beds', 'homey'); ?>, 
                                                                <?php echo esc_html($room['guests']); ?> <?php esc_html_e('guests', 'homey'); ?>)
                                                            </li>
                                                        <?php endforeach; ?>
                                                    </ul>
                                                </li>
