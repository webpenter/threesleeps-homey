...
<div class="form-step">
    ...
    <div class="block">
        ...
        <div class="block-body">
            ...
            <?php if($hide_fields['room_type'] != 1 && $_GET['mode_multi'] != 'per_day_multi') { ?>
            <div class="row">
            ...
            <div class="row">
                ...
                $fields_array = Homey_Fields_Builder::get_form_fields();
                    ...
                    if(!empty($fields_array) && $_GET['mode_multi'] !='per_day_multi') {
            ...
            <div class="row">
                ...
                <?php if($hide_fields['listing_bedrooms'] != 1 && $_GET['mode_multi'] !='per_day_multi') { ?>
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                ...
                <?php if($hide_fields['guests'] != 1 && $_GET['mode_multi'] !='per_day_multi') { ?>
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                ...
                <?php if($hide_fields['beds'] != 1 && $_GET['mode_multi'] !='per_day_multi') { ?>
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                ...
                <?php if($hide_fields['baths'] != 1 && $_GET['mode_multi'] !='per_day_multi') { ?>
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                ...
                <?php if($hide_fields['listing_rooms'] != 1 && $_GET['mode_multi'] !='per_day_multi') { ?>
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                ...
                <?php if($hide_fields['listing_size'] != 1 && $_GET['mode_multi'] !='per_day_multi') { ?>
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                ...
                <?php if($hide_fields['listing_size_unit'] != 1 && $_GET['mode_multi'] !='per_day_multi') { ?>
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                ...
                <?php if(@$hide_fields['affiliate_booking_link'] != 1 && $_GET['mode_multi'] !='per_day_multi') { ?>
