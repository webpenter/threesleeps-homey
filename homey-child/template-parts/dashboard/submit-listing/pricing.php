            ...
            <div class="row">
				...
				<div class="col-sm-12 col-xs-12">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="listing_payout_booking" placeholder="<?php echo esc_html__('Check how much initial payment you want the client to deposit while booking', 'homey');?>">
					</div>
				</div>
                <?php } ?>
