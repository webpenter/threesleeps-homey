                ...
                <div class="more_rooms_wrap">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="acc_bedroom_description"><?php echo esc_html__('Descripción'); ?></label>
                                <input type="text" name="homey_accomodation[0][acc_bedroom_description]"  class="form-control" placeholder="<?php echo esc_html__('Descripción del alojamiento'); ?>">
                            </div>
                        </div>
                    </div>
                        <div class="col-sm-6 col-xs-12">
