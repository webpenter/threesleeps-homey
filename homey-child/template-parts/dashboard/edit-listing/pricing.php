...
$listing_payout_booking = homey_get_field_meta('listing_payout_booking');
    ...
    <div class="block-body">
        <div class="row">
			...
			<div class="col-sm-12 col-xs-12">
				<div class="form-group">
					<label for="listing_payout_booking"> <?php echo esc_html__('Payment while booking', 'homey'); ?> </label>
					<input type="text" class="form-control" value="<?php echo $listing_payout_booking; ?>" name="listing_payout_booking" placeholder="<?php echo esc_html__('Check how much initial payment you want the client to deposit while booking', 'homey');?>">
				</div>
			</div>
            <?php } ?>
