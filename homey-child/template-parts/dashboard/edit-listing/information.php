...
$multiroom_booking = homey_get_field_meta('multiroom_booking');
...
<div id="information-tab" class="tab-pane fade <?php echo esc_attr($class); ?>">
    ...
    <div class="block-body">
        ...
        <div class="row">
            ...
            <?php if($hide_fields['listing_bedrooms'] != 1 && $multiroom_booking != 'per_day_multi') { ?>
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
            ...
            <?php if($hide_fields['beds'] != 1 && $multiroom_booking != 'per_day_multi') { ?>
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
			...
			<?php if($hide_fields['tax_rate'] != 1 && homey_option('tax_type') == 'single_tax' && $multiroom_booking == 'per_day_multi'){ ?>
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    <label for="tax_rate"><?php echo esc_attr(homey_option('ad_tax_rate_label')); ?></label>
                    <input type="text" name="tax_rate" value="<?php homey_field_meta('tax_rate'); ?>" class="form-control" id="tax_rate" placeholder="<?php echo esc_attr(homey_option('ad_tax_rate_plac')); ?>">
                </div>
            </div>
            <?php } ?>
			
            <?php if($hide_fields['listing_rooms'] != 1 && $multiroom_booking != 'per_day_multi') { ?>
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
            ...
            <?php if($hide_fields['listing_size'] != 1 && $multiroom_booking != 'per_day_multi') { ?>
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
            ...
            <?php if($hide_fields['listing_size_unit'] != 1 && $multiroom_booking != 'per_day_multi') { ?>
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
            ...
            <?php if($hide_fields['affiliate_booking_link'] != 1 && $multiroom_booking != 'per_day_multi') { ?>
    ...
    <?php if($hide_fields['section_openning'] != 1 && $multiroom_booking != 'per_day_multi') { ?>
