...
$cancel_max_days = homey_get_field_meta('cancel_max_days');
...
<div id="rules-tab" class="tab-pane fade <?php echo esc_attr($class); ?>">
    ...
    <div class="block-body">
        ...
        <div class="row">
			...
			<!--Máximo días para política de cancelación-->
			<div class="col-sm-6 col-xs-12">
               <div class="form-group">
                  <label for="cancel_max_days_title"><?php echo esc_html__('Máximo días para realizar la cancelación (%d)', 'homey')?></label>
                    <input type="text" name="cancel_max_days" value="<?php echo esc_attr($cancel_max_days); ?>" class="form-control" <?php homey_required('cancel_max_days'); ?> id="cancel_max_days" placeholder="<?php echo esc_html__('Introduce el número de días máximo para poder cancelar la reserva', 'homey'); ?>">
               </div>
            </div>
        </div>
        <?php } ?>
