...
$cif            		=   get_the_author_meta( 'cif' , $userID );
$razon_social      		=   get_the_author_meta( 'razon_social' , $userID );
...
<!--            --><?php //if ($is_allowed_change_role == 1 && $is_role_settled != 1 && ! homey_is_admin()){ ?>
			...
			<div class="col-sm-6">
                <div class="form-group">
                    <label for="razon_social"><?php echo esc_html__( 'Razón social', 'homey_child' ); ?></label>
                    <input type="text" id="razon_social" class="form-control" value="<?php echo esc_attr($razon_social);?>" placeholder="<?php echo esc_html__( 'Introduce la razón social', 'homey_child' ); ?>">
                </div>
			</div>
			
			<div class="col-sm-6">
                <div class="form-group">
                    <label for="cif"><?php echo esc_html__( 'CIF/NIF', 'homey_child' ); ?></label>
                    <input type="text" id="cif" class="form-control" value="<?php echo esc_attr($cif);?>" placeholder="<?php echo esc_html__( 'Introduce tu número de identificación fiscal', 'homey_child' ); ?>">
                </div>
			</div>
