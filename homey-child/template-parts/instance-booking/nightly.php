...
$check_availability = check_booking_availability($check_in, $check_out, $listing_id, $guests, $multi_listing, $selectedRooms);
                        ...
                        <div class="block-body homey-booking-block-body-3" style="display: none;">
                            ...
                            <?php if( homey_is_woocommerce() ) { 
                                ...
                                <button id="make_woocommerce_instant_booking_payment" type="button" class="btn btn-booking btn-full-width"><?php echo esc_attr($homey_local['btn_process_pay']); ?></button>
                                    ...
                                    <div id="without_stripe" class="continue-block-button">
                                        ...
                                        <!-- Sadiq multiroom -->
                                        <input type="hidden" id="multi_listing" value="<?php echo esc_html($multi_listing); ?>">
                                        <input type="hidden" id="selectedRoom" value='<?php echo json_encode($selectedRooms); ?>'>
                            ...
                            <form name="homey_checkout" method="post" class="homey_payment_form" action="<?php echo esc_url($stripe_processor_link); ?>">
                                ...
                                if( $enable_stripe != 0 ) {
                                    ...
                                    homey_stripe_payment_instance($listing_id, $check_in, $check_out, $guests, $guest_message, $adult_guest, $child_guest, $multi_listing, $selectedRooms);
