            ...
            <div class="gallery-grid-left-wrap">
                <?php foreach( $listing_images as  $indexNum => $image ) {
                    ...
                    <div class="gallery-grid-item">
                        <?php if($i > 4){ ?><a data-fancy-image-index="<?php echo $i-1; ?>" class="btn gallery-grid-button fanboxTopGalleryVar-item"><?php echo esc_html__("View More Photos", "homey");?></a><?php } ?>
